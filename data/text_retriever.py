...
class RetrieverDataset(Dataset):
    ...
    def get_features(self):    
        ...
        for example in tqdm(self.data_all):
            ...
            pos_sent_features, neg_sent_features = features[0], features[1]
        ...
        if self.mode == "train":
            ...
            data = res + res_neg_sent[:min(len(res_neg_sent),len(res))]
        else:
            data = res + res_neg_sent
    ...
    def convert_example_to_feature(self,example):
        ...
        return pos_sent_features, neg_sent_features
